				...
				<form method="post" enctype="multipart/form-data" action="doAction.php?act=reg">
					<ul class="login">
						...
						<li>
							...
							<div class="input_item">
								<input type="password" name="password" class="login_input user_icon" required="required">
							</div>
						</li>
						<li>
							<span class="reg_item">
							...
							<div class="input_item">
								<input type="email" name="email" placeholder="请输入合法邮箱" class="login_input user_icon"
								required="required">
							</div>
						</li>
						<li>
							...
							<div class="input_item">
								...
								男
								<input type="radio" checked="checked" name="sex" value="2">
								女
